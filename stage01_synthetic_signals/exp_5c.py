...
# -----------------------------
# Experiment 5C: compare no window and Hann window
# -----------------------------
...
freqs_rect, amp_rect = compute_fft_windowed(
    x,
    fs,
    window_type="rectangular"
)

freqs_hann, amp_hann = compute_fft_windowed(
    x,
    fs,
    window_type="hann"
)
...
plt.figure(figsize=(10, 4))
plt.plot(freqs_rect, amp_rect, label="Rectangular window")
plt.plot(freqs_hann, amp_hann, label="Hann window")
plt.xlim(0, 8)
plt.xlabel("Frequency [Hz]")
plt.ylabel("Amplitude")
...
print("Rectangular window peaks:")
print_dominant_frequencies(freqs_rect, amp_rect, n_peaks=8)

print("\nHann window peaks:")
print_dominant_frequencies(freqs_hann, amp_hann, n_peaks=8)