...
# -----------------------------
# Experiment 3: noise sensitivity with SNR
# -----------------------------
...
def compute_snr_db(clean_signal, noisy_signal):
    """
...
t_clean, x_clean = generate_signal(
    fs=fs,
    T=T,
...
for noise_std in noise_levels:
    ...
    snr_db = compute_snr_db(x_clean, x)
    ...
    plot_time_and_frequency(
        ...
        freqs,
        amplitude,
        title=f"Noise std = {noise_std}, SNR = {snr_db:.2f} dB"
    )
